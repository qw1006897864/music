...
_(fE,cF)
var hG=_mz(z,'input',['class',3,'confirmType',1,'placeholder',2,'placeholderClass',3],[],e,s,gg)
_(fE,hG)
_(oD,fE)
var oH=_mz(z,'swiper',['autoplay',-1,'circular',-1,'indicatorDots',-1,'class',7,'duration',1,'indicatorActiveColor',2,'interval',3,'ndicatorColor',4],[],e,s,gg)
_(oD,oH)
_(r,oD)
return r
}
