...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'dis-content data-v-7d3a07f8'])
Z([3,'__e'])
Z([3,'btn data-v-7d3a07f8'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'content data-v-15d4e87c'])
Z([3,'audio-content data-v-15d4e87c'])
Z([3,'wx-header data-v-15d4e87c'])
Z([3,'text data-v-15d4e87c'])
Z([a,[[6],[[7],[3,'songData']],[3,'songname']]])
Z([3,'__e'])
Z([3,'data-v-15d4e87c'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'back']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'/static/img/icon/list/left_arrow.png'])
Z([3,'audio-title data-v-15d4e87c'])
Z([a,[[6],[[7],[3,'songData']],[3,'singer']]])
Z([3,'audio-bg data-v-15d4e87c'])
Z([3,'image-auto  data-v-15d4e87c'])
Z([[6],[[7],[3,'songData']],[3,'imgurl']])
Z([3,'audio-middle data-v-15d4e87c'])
Z([3,'audio-rotate data-v-15d4e87c'])
Z([3,'audio-rotate-bg data-v-15d4e87c'])
Z([[4],[[5],[[5],[1,'audio-rotate-image image-auto data-v-15d4e87c']],[[2,'?:'],[[7],[3,'playState']],[1,'play'],[1,'play pause']]]])
Z(z[13])
Z([3,'audio-lyric data-v-15d4e87c'])
Z([a,[[2,'+'],[[2,'+'],[1,''],[[7],[3,'playingLyric']]],[1,'']]])
Z([3,'audio-controls data-v-15d4e87c'])
Z([3,'progress data-v-15d4e87c'])
Z(z[6])
Z([a,[[7],[3,'startTime']]])
Z([3,'progress-item data-v-15d4e87c'])
Z([3,'#19be6b'])
...
Z(z[6])
Z([a,[[7],[3,'endTime']]])
Z([3,'audio-controls-image-content data-v-15d4e87c'])
Z(z[5])
Z([3,'audio-controls-scale-image data-v-15d4e87c'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'prevAudio']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'/static/img/icon/play/prev-audio.png'])
Z([[2,'!'],[[7],[3,'playState']]])
Z(z[5])
Z([3,'audio-controls-image data-v-15d4e87c'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'rank-content data-v-2a86e450'])
Z([3,'index'])
Z([3,'item'])
Z([[7],[3,'rankList']])
Z(z[1])
Z([3,'__e'])
Z([3,'rank-item data-v-2a86e450'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[[5],[1,'selectRank']],[[4],[[5],[1,'$0']]]],[[4],[[5],[[4],[[5],[[4],[[5],[[5],[[5],[1,'rankList']],[1,'']],[[7],[3,'index']]]]]]]]]]]]]]]])
Z([3,'rank-image-content data-v-2a86e450'])
Z([3,'data-v-2a86e450'])
Z([3,'true'])
Z([[6],[[7],[3,'item']],[3,'picUrl']])
Z([3,'right-item data-v-2a86e450'])
Z([3,'childIndex'])
Z([3,'child'])
Z([[6],[[7],[3,'item']],[3,'songList']])
Z(z[13])
Z([3,'song-list data-v-2a86e450'])
Z([3,'song-index data-v-2a86e450'])
Z([a,[[2,'+'],[1,'0'],[[2,'+'],[[7],[3,'childIndex']],[1,1]]]])
Z([3,'song-item data-v-2a86e450'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'recommend data-v-b39f42dc'])
Z([3,'__e'])
Z([3,'scroll-view data-v-b39f42dc'])
Z([[4],[[5],[[4],[[5],[[5],[1,'scrolltolower']],[[4],[[5],[[4],[[5],[[5],[1,'scrolltolower']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([[2,'+'],[[2,'+'],[1,'height:'],[[7],[3,'windowHeight']]],[1,'px']])
Z([3,'recommend-title data-v-b39f42dc'])
Z([3,'data-v-b39f42dc'])
Z([3,'歌单推荐'])
Z([3,'recommend-content data-v-b39f42dc'])
Z([3,'index'])
Z([3,'item'])
Z([[7],[3,'recommendList']])
Z(z[9])
Z(z[1])
Z([3,'recommend-item data-v-b39f42dc'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[[5],[1,'selectRecommendSong']],[[4],[[5],[1,'$0']]]],[[4],[[5],[[4],[[5],[[4],[[5],[[5],[[5],[1,'recommendList']],[1,'']],[[7],[3,'index']]]]]]]]]]]]]]]])
Z([3,'recommend-item-image data-v-b39f42dc'])
Z([3,'true'])
Z([[6],[[7],[3,'item']],[3,'imgurl']])
Z([3,'recommend-listen-num data-v-b39f42dc'])
Z(z[6])
Z([3,'/static/img/icon/home/headset.png'])
Z(z[6])
Z([a,[[6],[[7],[3,'item']],[3,'listennum']]])
Z([3,'recommend-item-title data-v-b39f42dc'])
Z(z[6])
Z([a,[[2,'+'],[[6],[[7],[3,'item']],[3,'dissname']],[1,'']]])
Z([[7],[3,'isLoading']])
Z([3,'__l'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'recommend-content data-v-4b5b5334'])
Z([3,'__e'])
Z([3,'data-v-4b5b5334'])
Z([[4],[[5],[[4],[[5],[[5],[1,'scroll']],[[4],[[5],[[4],[[5],[[5],[1,'scroll']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([[2,'+'],[[2,'+'],[1,'height:'],[[7],[3,'windowHeight']]],[1,'px']])
Z([3,'wx-header data-v-4b5b5334'])
Z([3,'headerTitle'])
Z([3,'bg data-v-4b5b5334'])
Z([[2,'+'],[[2,'+'],[[2,'+'],[[2,'+'],[1,'opacity:'],[[7],[3,'headerOpacity']]],[1,';background-image:url(']],[[6],[[7],[3,'header']],[3,'backgroundUrl']]],[1,');']])
Z([3,'bg-c data-v-4b5b5334'])
Z([[2,'+'],[[2,'+'],[1,'opacity:'],[[7],[3,'headerOpacity']]],[1,';']])
Z([3,'text data-v-4b5b5334'])
Z([3,'header-title data-v-4b5b5334'])
Z([a,[[6],[[7],[3,'header']],[3,'title']]])
Z(z[1])
Z(z[2])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'back']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'/static/img/icon/list/left_arrow.png'])
Z([3,'header-content data-v-4b5b5334'])
Z([3,'headerContent'])
Z([3,'header-filter data-v-4b5b5334'])
Z([[2,'+'],[[2,'+'],[1,'background-image:url('],[[6],[[7],[3,'header']],[3,'backgroundUrl']]],[1,');']])
Z([3,'header-item-left data-v-4b5b5334'])
Z([3,'header-image data-v-4b5b5334'])
Z([[6],[[7],[3,'header']],[3,'backgroundUrl']])
Z([3,'header-listennum data-v-4b5b5334'])
Z(z[2])
Z([3,'/static/img/icon/home/headset.png'])
Z(z[2])
Z([a,[[6],[[7],[3,'header']],[3,'listennum']]])
Z([3,'header-item-right data-v-4b5b5334'])
Z([3,'header-dissname data-v-4b5b5334'])
Z([a,[[6],[[7],[3,'header']],[3,'dissname']]])
Z([3,'header-logo data-v-4b5b5334'])
Z([3,'header-scale-image data-v-4b5b5334'])
Z([[6],[[7],[3,'header']],[3,'logo']])
Z([3,'header-scale-text data-v-4b5b5334'])
Z([a,[[6],[[7],[3,'header']],[3,'nickname']]])
Z([3,'scroll-view-content data-v-4b5b5334'])
Z([3,'play-set data-v-4b5b5334'])
Z([3,'play-left data-v-4b5b5334'])
Z([3,'play data-v-4b5b5334'])
Z([3,'/static/img/icon/list/play-red.png'])
Z(z[2])
Z([a,[[2,'+'],[[2,'+'],[1,'全部播放('],[[6],[[7],[3,'songList']],[3,'length']]],[1,')']]])
Z([3,'play-right data-v-4b5b5334'])
Z([3,'play-list data-v-4b5b5334'])
...
Z(z[48])
Z(z[1])
Z([3,'scroll-view-item data-v-4b5b5334'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[[5],[1,'selectSong']],[[4],[[5],[[5],[1,'$0']],[[7],[3,'index']]]]],[[4],[[5],[[4],[[5],[[4],[[5],[[5],[[5],[1,'songList']],[1,'']],[[7],[3,'index']]]]]]]]]]]]]]]])
Z([3,'scroll-item-left data-v-4b5b5334'])
Z([3,'song-index data-v-4b5b5334'])
Z([a,[[2,'+'],[[7],[3,'index']],[1,1]]])
Z([3,'recommendImage data-v-4b5b5334'])
Z([3,'true'])
Z([[6],[[7],[3,'item']],[3,'imgurl']])
Z([3,'scroll-item-right data-v-4b5b5334'])
Z([3,'singer-content data-v-4b5b5334'])
Z([3,'song-name data-v-4b5b5334'])
Z([a,[[6],[[7],[3,'item']],[3,'songname']]])
Z([3,'singer-name data-v-4b5b5334'])
Z([a,[[6],[[7],[3,'item']],[3,'singer']]])
Z([3,'play-image data-v-4b5b5334'])
Z([3,'/static/img/icon/list/diandian.png'])
Z([[2,'=='],[[6],[[7],[3,'songList']],[3,'length']],[1,0]])
Z([3,'song-num-zero data-v-4b5b5334'])
Z(z[2])
Z([3,'暂无数据'])
Z([[7],[3,'isLoading']])
Z([3,'__l'])
...
__wxAppCode__['pages/discover/discover.wxss']=setCssToHead([".",[1],"dis-content.",[1],"data-v-7d3a07f8 { width: 100%; padding: ",[0,20],"; }\n.",[1],"btn.",[1],"data-v-7d3a07f8 { -webkit-box-sizing: border-box; box-sizing: border-box; display: block; margin-bottom: 20px; padding: 5px 10px; border-radius: 10px; width: 100%; color: #fff; font-size: 20px; text-align: center; background: -webkit-gradient(linear, right top, left top, from(rgba(255, 56, 64, 1)), to(rgba(255, 123, 85, 1))); background: -o-linear-gradient(right, rgba(255, 56, 64, 1) 0%, rgba(255, 123, 85, 1) 100%); background: linear-gradient(270deg, rgba(255, 56, 64, 1) 0%, rgba(255, 123, 85, 1) 100%); -webkit-box-shadow: 0px 8px 20px 0px rgba(255, 188, 188, 1); box-shadow: 0px 8px 20px 0px rgba(255, 188, 188, 1); }\n",],undefined,{path:"./pages/discover/discover.wxss"});    
...
__wxAppCode__['pages/playMusic/playMusic.wxss']=setCssToHead([".",[1],"content.",[1],"data-v-15d4e87c { width: 100%; height: 100%; overflow: hidden; }\n.",[1],"image-auto.",[1],"data-v-15d4e87c { width: 100%; height: 100%; }\n.",[1],"audio-content.",[1],"data-v-15d4e87c { position: absolute; top: 0; left: 0; height: 100%; width: 100%; background: #333; padding-top: var(--status-bar-height); -webkit-box-sizing: border-box; box-sizing: border-box; overflow: hidden; }\n.",[1],"audio-bg.",[1],"data-v-15d4e87c { position: absolute; top: 0; left: 0; height: 100%; width: 100%; -webkit-filter: blur(",[0,40],"); filter: blur(",[0,40],"); opacity: 0.6; overflow: hidden; }\n.",[1],"audio-title.",[1],"data-v-15d4e87c { font-size: ",[0,24],"; text-align: center; padding: ",[0,20],"; -webkit-box-sizing: border-box; box-sizing: border-box; color: #fff; }\n.",[1],"audio-middle.",[1],"data-v-15d4e87c { width: 100%; height: 60%; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; z-index: 10; position: relative; }\n.",[1],"audio-rotate.",[1],"data-v-15d4e87c { display: inline-block; vertical-align: top; position: relative; width: 100%; height: 0; padding-top: 60%; }\n.",[1],"audio-rotate-bg.",[1],"data-v-15d4e87c { position: absolute; left: 20%; top: 10%; width: 60%; -webkit-box-sizing: border-box; box-sizing: border-box; height: 100%; background: rgba(255, 255, 255, 0.1); border-radius: 50%; padding: ",[0,20],"; }\n.",[1],"audio-rotate-bg wx-image.",[1],"data-v-15d4e87c { width: 100%; height: 100%; }\n.",[1],"audio-rotate-image.",[1],"data-v-15d4e87c { border-radius: 50%; }\n.",[1],"audio-rotate-image.",[1],"play.",[1],"data-v-15d4e87c { -webkit-animation: rotate-data-v-15d4e87c 20s linear infinite; animation: rotate-data-v-15d4e87c 20s linear infinite; }\n.",[1],"audio-rotate-image.",[1],"pause.",[1],"data-v-15d4e87c { -webkit-animation-play-state: paused; animation-play-state: paused; }\n@-webkit-keyframes rotate-data-v-15d4e87c { 0% { -webkit-transform: rotate(0); transform: rotate(0); }\n100% { -webkit-transform: rotate(360deg); transform: rotate(360deg); }\n}@keyframes rotate-data-v-15d4e87c { 0% { -webkit-transform: rotate(0); transform: rotate(0); }\n100% { -webkit-transform: rotate(360deg); transform: rotate(360deg); }\n}.",[1],"audio-controls.",[1],"data-v-15d4e87c { z-index: 10; }\n.",[1],"audio-controls-image-content.",[1],"data-v-15d4e87c { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-justify-content: space-around; -ms-flex-pack: distribute; justify-content: space-around; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; padding: ",[0,20]," ",[0,60],"; }\n.",[1],"audio-controls-scale-image.",[1],"data-v-15d4e87c { width: ",[0,80],"; height: ",[0,80],"; border-radius: 50%; z-index: 100; }\n.",[1],"audio-controls-image.",[1],"data-v-15d4e87c { width: ",[0,120],"; height: ",[0,120],"; border-radius: 50%; z-index: 100; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-justify-content: space-around; -ms-flex-pack: distribute; justify-content: space-around; }\n.",[1],"progress.",[1],"data-v-15d4e87c { font-size: ",[0,24],"; color: #fff; padding: ",[0,30],"; -webkit-box-sizing: border-box; box-sizing: border-box; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; }\n.",[1],"progress \x3e wx-text.",[1],"data-v-15d4e87c { width: 10%; }\n.",[1],"progress-item.",[1],"data-v-15d4e87c { -webkit-box-sizing: border-box; box-sizing: border-box; display: inline-block; width: 100%; }\n.",[1],"audio-lyric.",[1],"data-v-15d4e87c { text-align: center; position: absolute; width: 100%; font-size: ",[0,30],"; color: rgba(255, 255, 255, 0.7); bottom: 5%; padding: 0 ",[0,40],"; -webkit-box-sizing: border-box; box-sizing: border-box; }\n.",[1],"wx-header.",[1],"data-v-15d4e87c { width: 100%; height: ",[0,80],"; text-align: center; color: #fff; z-index: 10; overflow: hidden; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; position: relative; }\n.",[1],"wx-header wx-image.",[1],"data-v-15d4e87c { width: 16px; height: 16px; position: absolute; left: 10px; top: 50%; -webkit-transform: -webkit-translateY(-50%); transform: -webkit-translateY(-50%); transform: -moz-translateY(-50%); transform: -o-translateY(-50%); -ms-transform: translateY(-50%); transform: translateY(-50%); }\n.",[1],"wx-header .",[1],"text.",[1],"data-v-15d4e87c { color: rgba(255, 255, 255, 0.7); font-size: 16px; text-align: center; -webkit-box-sizing: border-box; box-sizing: border-box; padding: 0 30px 0 30px; -o-text-overflow: ellipsis; text-overflow: ellipsis; overflow: hidden; white-space: nowrap; }\n",],undefined,{path:"./pages/playMusic/playMusic.wxss"});    
__wxAppCode__['pages/playMusic/playMusic.wxml']=$gwx('./pages/playMusic/playMusic.wxml');

__wxAppCode__['pages/rank/rank.wxss']=setCssToHead([".",[1],"rank-content.",[1],"data-v-2a86e450 { padding: ",[0,20],"; -webkit-box-sizing: border-box; box-sizing: border-box; width: 100%; }\n.",[1],"rank-item.",[1],"data-v-2a86e450 { padding: ",[0,20],"; -webkit-box-sizing: border-box; box-sizing: border-box; background: #F9F9F9; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; margin-bottom: ",[0,10],"; width: 100%; }\n.",[1],"rank-image-content.",[1],"data-v-2a86e450 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; }\n.",[1],"rank-image-content wx-image.",[1],"data-v-2a86e450 { width: ",[0,140],"; height: ",[0,140],"; border-radius: ",[0,10],"; background: #000000; }\n.",[1],"right-item.",[1],"data-v-2a86e450 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; padding-left: ",[0,20],"; -webkit-box-sizing: border-box; box-sizing: border-box; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; width: 80%; }\n.",[1],"song-list.",[1],"data-v-2a86e450 { white-space: nowrap; overflow: hidden; -o-text-overflow: ellipsis; text-overflow: ellipsis; }\n.",[1],"song-index.",[1],"data-v-2a86e450 { color: #bbb; font-size: ",[0,24],"; margin-right: ",[0,10],"; -webkit-box-sizing: border-box; box-sizing: border-box; }\n.",[1],"song-item.",[1],"data-v-2a86e450 { font-size: ",[0,26],"; color: #888; }\n",],undefined,{path:"./pages/rank/rank.wxss"});    
__wxAppCode__['pages/rank/rank.wxml']=$gwx('./pages/rank/rank.wxml');

__wxAppCode__['pages/recommend/recommend.wxss']=setCssToHead([".",[1],"recommend.",[1],"data-v-b39f42dc { height: 100%; padding: ",[0,20]," ",[0,20]," ",[0,40],"; }\n.",[1],"scroll-view.",[1],"data-v-b39f42dc { width: 100%; }\n.",[1],"recommend-content.",[1],"data-v-b39f42dc { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-flex-wrap: wrap; -ms-flex-wrap: wrap; flex-wrap: wrap; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; overflow: auto; }\n.",[1],"recommend-title.",[1],"data-v-b39f42dc { color: #EA4758; font-size: ",[0,36],"; padding: 0 ",[0,10],"; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; }\n.",[1],"recommend-title .",[1],"more.",[1],"data-v-b39f42dc { color: #ccc; font-size: ",[0,24],"; }\n.",[1],"recommend-item.",[1],"data-v-b39f42dc { width: 33.3%; z-index: 2; position: relative; padding: ",[0,10],"; -webkit-box-sizing: border-box; box-sizing: border-box; }\n.",[1],"recommend-item-title.",[1],"data-v-b39f42dc { color: #666; font-size: ",[0,20],"; line-height: ",[0,30],"; }\n.",[1],"recommend-item-image.",[1],"data-v-b39f42dc { border-radius: ",[0,10],"; width: 100%; height: ",[0,200],"; }\n.",[1],"recommend-listen-num.",[1],"data-v-b39f42dc { font-size: ",[0,24],"; color: #fff; position: absolute; left: ",[0,20],"; top: ",[0,170],"; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; }\n.",[1],"recommend-listen-num wx-image.",[1],"data-v-b39f42dc { width: ",[0,24],"; height: ",[0,24],"; margin-right: ",[0,15],"; padding-top: ",[0,5],"; }\n.",[1],"recommend-footer.",[1],"data-v-b39f42dc { text-align: center; }\n.",[1],"recommend-footer wx-text.",[1],"data-v-b39f42dc { display: inline-block; color: #bbb; font-size: ",[0,24],"; border: 1px solid #ddd; border-radius: ",[0,10],"; padding: ",[0,5]," ",[0,20],"; }\n",],undefined,{path:"./pages/recommend/recommend.wxss"});    
__wxAppCode__['pages/recommend/recommend.wxml']=$gwx('./pages/recommend/recommend.wxml');

__wxAppCode__['pages/recommendDetail/recommendDetail.wxss']=setCssToHead([".",[1],"image-auto.",[1],"data-v-4b5b5334 { width: 100%; height: 100%; }\n.",[1],"recommend-content.",[1],"data-v-4b5b5334 { width: 100%; }\n.",[1],"wx-header.",[1],"data-v-4b5b5334 { position: fixed; top: 0; left: 0; width: 100%; height: calc(var(--status-bar-height) + ",[0,80],"); text-align: center; color: #fff; z-index: 10; overflow: hidden; }\n.",[1],"wx-header wx-image.",[1],"data-v-4b5b5334 { width: 16px; height: 16px; position: absolute; left: ",[0,10],"; top: 50%; -webkit-transform: -webkit-translateY(-50%); transform: -webkit-translateY(-50%); transform: -moz-translateY(-50%); transform: -o-translateY(-50%); -ms-transform: translateY(-50%); transform: translateY(-50%); }\n.",[1],"wx-header .",[1],"text.",[1],"data-v-4b5b5334 { z-index: 10; position: absolute; text-align: center; width: 100%; left: 0; bottom: ",[0,20],"; -webkit-box-sizing: border-box; box-sizing: border-box; bottom: 8px; -o-text-overflow: ellipsis; text-overflow: ellipsis; overflow: hidden; padding: 0 30px 0 30px; white-space: nowrap; }\n.",[1],"wx-header wx-view.",[1],"bg.",[1],"data-v-4b5b5334 { position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 2; -webkit-filter: brightness(0.6) blur(20px); -moz-filter: brightness(0.6) blur(20px); -o-filter: brightness(0.6) blur(20px); filter: brightness(0.6) blur(20px); background-size: 100% auto; background-repeat: no-repeat; }\n.",[1],"wx-header .",[1],"bg-c.",[1],"data-v-4b5b5334 { z-index: 1; position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: #fcfcfc; }\n.",[1],"header-content.",[1],"data-v-4b5b5334 { width: 100%; padding: ",[0,30],"; height: calc(var(--status-bar-height) + ",[0,420],"); padding-top: calc(var(--status-bar-height) + ",[0,80],"); background-size: 100% auto; position: relative; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; -webkit-box-sizing: border-box; box-sizing: border-box; overflow: hidden; }\n.",[1],"header-filter.",[1],"data-v-4b5b5334 { position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.5); z-index: 1; -webkit-filter: brightness(0.6) blur(20px); -moz-filter: brightness(0.6) blur(20px); -o-filter: brightness(0.6) blur(20px); filter: brightness(0.6) blur(20px); background-size: 100% auto; background-repeat: no-repeat; }\n.",[1],"header-item-left.",[1],"data-v-4b5b5334 { width: ",[0,200],"; height: ",[0,200],"; z-index: 2; position: relative; }\n.",[1],"header-listennum.",[1],"data-v-4b5b5334 { font-size: ",[0,24],"; color: #fff; position: absolute; bottom: ",[0,10],"; left: ",[0,20],"; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; }\n.",[1],"header-listennum wx-image.",[1],"data-v-4b5b5334 { width: ",[0,24],"; height: ",[0,24],"; margin-right: ",[0,10],"; padding-top: ",[0,5],"; }\n.",[1],"header-item-right.",[1],"data-v-4b5b5334 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; height: 80%; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; -webkit-justify-content: space-around; -ms-flex-pack: distribute; justify-content: space-around; padding-left: ",[0,40],"; -webkit-box-sizing: border-box; box-sizing: border-box; z-index: 2; position: relative; }\n.",[1],"header-image.",[1],"data-v-4b5b5334 { width: ",[0,200],"; height: ",[0,200],"; border-radius: ",[0,10],"; }\n.",[1],"header-image wx-image.",[1],"data-v-4b5b5334 { border-radius: ",[0,10],"; }\n.",[1],"recommendImage.",[1],"data-v-4b5b5334 { width: ",[0,100],"; height: ",[0,100],"; padding: 0; border-radius: ",[0,10],"; }\n.",[1],"header-dissname.",[1],"data-v-4b5b5334 { color: #fff; font-size: ",[0,40],"; }\n.",[1],"header-logo.",[1],"data-v-4b5b5334 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; }\n.",[1],"header-scale-image.",[1],"data-v-4b5b5334 { width: ",[0,40],"; height: ",[0,40],"; border-radius: 50%; }\n.",[1],"header-scale-text.",[1],"data-v-4b5b5334 { color: rgba(255, 255, 255, 0.8); font-size: ",[0,32],"; padding: 0 ",[0,10],"; -webkit-box-sizing: border-box; box-sizing: border-box; }\n.",[1],"scroll-view-content.",[1],"data-v-4b5b5334 { background: #fff; padding-top: ",[0,100],"; position: relative; }\n.",[1],"scroll-view-item.",[1],"data-v-4b5b5334 { -webkit-box-sizing: border-box; box-sizing: border-box; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; padding-right: ",[0,10],"; background: #fcfcfc; }\n.",[1],"scroll-item-left.",[1],"data-v-4b5b5334 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; padding-right: ",[0,30],"; }\n.",[1],"song-index.",[1],"data-v-4b5b5334 { font-size: ",[0,28],"; color: #666; text-align: center; display: inline-block; width: ",[0,60],"; }\n.",[1],"singer-content.",[1],"data-v-4b5b5334 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; width: 90%; }\n.",[1],"song-name.",[1],"data-v-4b5b5334 { font-size: ",[0,36],"; color: #333; margin-bottom: ",[0,10],"; }\n.",[1],"singer-name.",[1],"data-v-4b5b5334 { font-size: ",[0,26],"; color: #666; }\n.",[1],"scroll-item-right.",[1],"data-v-4b5b5334 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; width: 80%; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; padding: ",[0,20]," 0; border-bottom: 1px solid #f0f0f0; }\n.",[1],"play-image.",[1],"data-v-4b5b5334 { height: ",[0,70],"; width: 8%; }\n.",[1],"song-num-zero.",[1],"data-v-4b5b5334 { font-size: ",[0,30],"; color: #666; text-align: center; padding-top: ",[0,100],"; }\n.",[1],"play-set.",[1],"data-v-4b5b5334 { position: absolute; top: 0; left: 0; width: 100%; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; padding: ",[0,20]," ",[0,40]," ",[0,20]," ",[0,20],"; background: #fff; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; font-size: ",[0,26],"; -webkit-box-sizing: border-box; box-sizing: border-box; -webkit-box-shadow: 0px 5px 8px -5px rgba(0, 0, 0, 0.1); box-shadow: 0px 5px 8px -5px rgba(0, 0, 0, 0.1); }\n.",[1],"play-left.",[1],"data-v-4b5b5334 { -webkit-box-flex: 5; -webkit-flex: 5; -ms-flex: 5; flex: 5; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; }\n.",[1],"play.",[1],"data-v-4b5b5334 { width: ",[0,60],"; height: ",[0,60],"; margin-right: ",[0,20],"; }\n.",[1],"download.",[1],"data-v-4b5b5334 { width: ",[0,40],"; height: ",[0,40],"; }\n.",[1],"play-list.",[1],"data-v-4b5b5334 { width: ",[0,40],"; height: ",[0,40],"; }\n.",[1],"play-right.",[1],"data-v-4b5b5334 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-flex: 1; -webkit-flex: 1; -ms-flex: 1; flex: 1; -webkit-box-pack: end; -webkit-justify-content: flex-end; -ms-flex-pack: end; justify-content: flex-end; }\n",],undefined,{path:"./pages/recommendDetail/recommendDetail.wxss"});    
